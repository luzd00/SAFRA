          ...
          <div className="flex items-center justify-between px-6 pt-6 pb-5 border-b border-emerald-900/50">
            <div className="flex items-center gap-3">
              <div className="w-11 h-11 rounded-2xl bg-emerald-500/20 border border-emerald-400/30 flex items-center justify-center text-emerald-300 shadow-inner">
                ...
                <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.3" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z"/>
                  <path d="M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 13 12"/>
                </svg>
              </div>
              <div>
                <span className="text-2xl font-black tracking-wider text-white block leading-tight">
                  SAFRA
                </span>
                <span className="text-[10px] text-emerald-300/90 font-medium block leading-tight mt-0.5">
                  Sistema de Acompanhamento Fácil de Rotinas Agrícolas
                </span>
              </div>
            </div>
