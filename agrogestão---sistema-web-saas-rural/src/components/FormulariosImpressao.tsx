    ...
    <div className="space-y-6 pb-16 animate-in fade-in duration-150">
      ...
      <div className="bg-white rounded-2xl p-5 border border-gray-200/90 shadow-xs no-print">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-gray-100">
          ...
          <button
            onClick={handlePrint}
            className="px-5 py-2.5 bg-[#0a2e23] hover:bg-[#062118] text-white rounded-xl text-xs md:text-sm font-bold flex items-center gap-2 shadow-md transition-all self-start cursor-pointer hover:shadow-lg"
          >
        ...
        <div className="pt-4 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <span className="text-xs text-gray-500 font-medium">Modo de Impressão:</span>
            <div className="flex items-center p-1 bg-gray-100 rounded-xl">
              <button
                ...
                className={`flex items-center gap-1.5 px-3 py-1 text-xs font-semibold rounded-lg transition-colors ${
                  mode === 'em-branco' ? 'bg-white text-emerald-900 shadow-2xs' : 'text-gray-600'
                }`}
              >
                <PenTool className="w-3.5 h-3.5 text-emerald-600" />
                <span>Em branco (Para Prancheta)</span>
              </button>
              <button
                onClick={() => setMode('com-dados')}
                className={`flex items-center gap-1.5 px-3 py-1 text-xs font-semibold rounded-lg transition-colors ${
                  mode === 'com-dados' ? 'bg-white text-emerald-900 shadow-2xs' : 'text-gray-600'
                }`}
              >
                <FileText className="w-3.5 h-3.5 text-emerald-600" />
                <span>Preenchido com Dados</span>
              </button>
            </div>
          </div>
        </div>
      ...
      {/* ========================================================================= */}
      <div className="bg-white rounded-2xl p-6 md:p-10 border border-gray-300 shadow-lg max-w-[960px] mx-auto print-page font-sans text-black">
        {/* Document Header matching official rural agronomy standards */}
        <div className="border-b-2 border-black pb-4 mb-4">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-lg border-2 border-black flex items-center justify-center font-black text-xl text-black">
                SF
              </div>
              <div>
            ...
            <div className="text-right border border-black p-2 rounded-md bg-gray-50 min-w-44">
        ...
        <div className="mt-8 pt-4 border-t-2 border-black grid grid-cols-2 gap-8 text-xs text-center">
          <div>
